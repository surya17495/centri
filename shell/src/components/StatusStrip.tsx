...
function Pill({
  ...
  return (
    <span
      title={title}
      className="inline-flex h-6 items-center gap-1.5 rounded-full border border-line bg-surface-1 px-2.5 text-[11px] font-medium text-ink-dim"
    >
      {children}
    </span>
  );
...
export function StatusStrip({
  ...
  return (
    <header className="flex h-12 shrink-0 items-center justify-between border-b border-line bg-surface-0/80 px-4 backdrop-blur">
      ...
      <div className="flex items-center gap-2">
        ...
        {configuredModels > 0 && (
          <button
            ...
            className="hidden h-6 items-center rounded-full border border-line bg-surface-1 px-2.5 text-[11px] font-medium text-ink-dim transition-colors hover:border-line-strong hover:text-ink sm:inline-flex"
